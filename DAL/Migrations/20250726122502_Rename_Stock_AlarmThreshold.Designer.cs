...
namespace DAL.Migrations
{
    ...
    [Migration("20250726122502_Rename_Stock_AlarmThreshold")]
    partial class Rename_Stock_AlarmThreshold
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Entities.DataRetriever", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<string>("LastRequestQuery")
                        .HasColumnType("TEXT");

                    b.Property<string>("LastResponseData")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("DAL.Entities.RetrieverLimitation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<int>("DataRetrieverId")
                        .HasColumnType("INTEGER");

                    b.Property<int>("Limit")
                        .HasColumnType("INTEGER");

                    b.Property<int>("RequestsDone")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("DataRetrieverId");

                    b.ToTable("RetrieverLimitations");
                });
            ...
            modelBuilder.Entity("DAL.Entities.Stock", b =>
                {
                    ...
                    b.Property<int>("DividendPayoutInterval")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<DateTime>("LastSectorUpdate")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("DAL.Entities.StockRetrieverCompatibility", b =>
                {
                    b.Property<int>("StockId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasKey("StockId", "DataRetrieverId");

                    b.HasIndex("DataRetrieverId");

                    b.ToTable("StockRetrieverCompatibility");
                });
            ...
            modelBuilder.Entity("DAL.Entities.RetrieverLimitation", b =>
                {
                    b.HasOne("DAL.Entities.DataRetriever", "DataRetriever")
                        .WithMany("RetrieverLimitations")
                        .HasForeignKey("DataRetrieverId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("DataRetriever");
                });
            ...
            modelBuilder.Entity("DAL.Entities.StockRetrieverCompatibility", b =>
                {
                    b.HasOne("DAL.Entities.DataRetriever", "DataRetriever")
                        .WithMany("StockRetrieverCompatibilities")
                        .HasForeignKey("DataRetrieverId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DAL.Entities.DataRetriever", b =>
                {
                    b.Navigation("RetrieverLimitations");

                    b.Navigation("StockRetrieverCompatibilities");
                });
